...
loss_agg_mode_for_update="seq-mean-token-mean"
...
# export MODEL_PATH=$ROOT/LlamaFactory/trainer_output
...
export EXP_NAME="qwen3-4b-polaris-baseline-gspo"
export WANDB_MODE=offline


# TRAIN_FILE=${DATA_DIR}/l1/deepscaler_add1k60step-overlong90step_add1k.parquet
# TRAIN_FILE=${DATA_DIR}/dapo-math-17k_qwen3_polaris.parquet
# TRAIN_FILE=$ROOT/data/l1/deepscaler_qwen3_polaris.parquet
# TRAIN_FILE=${DATA_DIR}/l1/dapo-math-17k_qwen3-add1k.parquet
TRAIN_FILE=$ROOT/data/qwen3-4b-s1-add1k.parquet
# TRAIN_FILE=${DATA_DIR}/deepmath-5k_qwen3_add1k.parquet
# TRAIN_FILE=${DATA_DIR}/l1/deepscaler_qwen3_polaris_add1k_new.parquet

# TEST_FILE=${DATA_DIR}/valid.v4.parquet
validation=${DATA_DIR}/luffy/valid-polaris-qwen3.parquet
# sampled1k=$ROOT/data/qwen3-4b-s1-sampled1k.parquet
# For Hydra, use comma-separated list format without quotes: [file1,file2]
...
actor_ppo_max_token_len=$((4 * (max_prompt_length + max_response_length)))
infer_ppo_max_token_len=$((4 * (max_prompt_length + max_response_length)))
max_num_batched_tokens=$((4 * (max_prompt_length + max_response_length)))
...
python3 -m recipe.dapo.main_dapo \
    ...
    custom_reward_function.path="$ROOT/verl041/verl/recipe/reward_ours/math_verify_reward.py" \
