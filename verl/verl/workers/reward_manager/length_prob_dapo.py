...
@register("length_prob_dapo")
class LengthProbDAPORewardManager:
    """The reward manager."""
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        reward_extra_info.update({"original_scores": torch.tensor(original_scores, dtype=torch.float32)})
        if return_dict:
            return {
